...
- [ ] 1. Verify libfiu availability and document the dependency
...
- [ ] 2. Add `pkg_check_modules(FIU QUIET fiu)` block to root `CMakeLists.txt`
...
- [ ] 3. Create `tests/chaos/` directory and stub `CMakeLists.txt`
...
- [ ] 4. Add a minimal smoke test to confirm the build pipeline works end-to-end
...
- [ ] 5. Write `tests/chaos/chaos_wrappers.hpp`
...
- [ ] 6. Verify that the wrapped types satisfy the kythira concepts
...
- [ ] 7. Write `tests/chaos/chaos_types.hpp`
...
- [ ] 8. Write `tests/chaos/fault_profiles.hpp`
...
- [ ] 9. Write `tests/chaos/safety_assertions.hpp`
...
- [ ] 10. Write integration smoke tests for each profile in
...
- [ ] 11. `tests/chaos/chaos_election_safety_test.cpp`
...
- [ ] 12. `tests/chaos/chaos_log_matching_test.cpp`
...
- [ ] 13. `tests/chaos/chaos_leader_completeness_test.cpp`
...
- [ ] 14. `tests/chaos/chaos_state_machine_safety_test.cpp`
...
- [ ] 15. `tests/chaos/chaos_leader_election_recovery_test.cpp`
...
- [ ] 16. `tests/chaos/chaos_commit_recovery_test.cpp`
...
- [ ] 17. `tests/chaos/chaos_persistence_degradation_recovery_test.cpp`
...
- [ ] 18. `tests/chaos/chaos_state_machine_recovery_test.cpp`
