...
concept membership_manager = requires(M manager, const NodeId& node, const Config& config) {
    ...
    // Notification when cluster membership changes
...
public:
    ...
    auto handle_cluster_membership_change(const cluster_configuration<NodeId>& old_config,
        ...
        // - Close network connections to removed nodes
        // - Establish connections to new nodes
        // - Update routing tables
        // - Notify monitoring and alerting systems
        // - Update security policies and access control lists
        // - Trigger rebalancing of data or workload
