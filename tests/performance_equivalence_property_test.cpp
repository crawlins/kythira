...
BOOST_AUTO_TEST_CASE(property_performance_equivalence, *boost::unit_test::timeout(90)) {
    ...
    try {
        ...
        // Verify that basic future operations meet performance expectations
        {
            ...
            constexpr auto max_expected_duration =
                std::chrono::milliseconds{500};  // More realistic
            ...
            BOOST_TEST_MESSAGE("Basic operations: " << num_operations << " operations in "
                                                    << duration.count() << "ms");
        ...
        // Verify that memory allocation patterns are efficient
        {
            ...
            constexpr auto max_expected_duration =
                std::chrono::milliseconds{200};  // More realistic
            ...
            BOOST_TEST_MESSAGE("Memory allocation: " << num_operations << " operations in "
                                                     << duration.count() << "ms");
        ...
        // Verify that concurrent operations scale appropriately
        {
            ...
            BOOST_TEST_MESSAGE("Concurrent operations: "
        ...
        // Verify that exception handling doesn't introduce significant overhead
        {
            ...
            BOOST_TEST_MESSAGE("Exception handling: " << num_operations << " operations in "
                                                      << duration.count() << "ms");
        ...
        // Verify that large objects are handled efficiently
        {
            ...
            BOOST_TEST_MESSAGE("Large object handling: " << num_operations << " operations in "
                                                         << duration.count() << "ms");
        ...
        // Verify that future concept methods are performant
        {
            ...
            BOOST_TEST_MESSAGE("isReady() calls: " << num_operations << " operations in "
                                                   << duration.count() << "ms");
        ...
        // Verify that overall throughput meets expectations
        {
            ...
            constexpr double min_ops_per_second =
                10000.0;  // More realistic minimum expected throughput
        ...
        // Verify that individual operation latency is low
        {
            ...
            BOOST_TEST_MESSAGE("Average latency: " << avg_latency.count() << "μs per operation");
        ...
        // Verify that memory usage is reasonable
        {
            ...
            for (size_t size : object_sizes) {
                ...
                BOOST_CHECK(ops_per_ms >
                            1.0);  // At least 1 operation per millisecond (more realistic)
            }
        }
    ...
    BOOST_TEST_MESSAGE(
        "Performance equivalence property validated: Future conversion "
