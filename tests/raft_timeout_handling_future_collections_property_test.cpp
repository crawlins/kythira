...
BOOST_AUTO_TEST_CASE(property_timeout_individual_futures_dont_block_collection,
...
BOOST_AUTO_TEST_CASE(property_timeout_classification_distinguishes_delays_from_failures,
                     *boost::unit_test::timeout(60)) {
...
BOOST_AUTO_TEST_CASE(property_timeout_adaptive_behavior_based_on_network_conditions,
                     *boost::unit_test::timeout(60)) {
...
BOOST_AUTO_TEST_CASE(property_timeout_validation_against_election_intervals,
