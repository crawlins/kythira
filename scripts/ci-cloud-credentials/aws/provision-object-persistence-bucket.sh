...
echo "  * an object-persistence bundle on the CI role's policy, scoped to"
echo "    arn:aws:s3:::${BUCKET}/${TEST_PREFIX}* (get/put/delete) and to the"
echo "    bucket itself (ListBucket, prefix-conditioned) — no bucket admin."
